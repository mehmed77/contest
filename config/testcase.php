...
function state_case($state, $case){
    $accepted   = "Accepted";
    switch ($state) {
        case -2: $accepted  = "<span class='text-center text-primary'>Running...</span>";
            break;
        case -1: $accepted = "<span class='text-center'>Running...</span>";
            break;
        ...
        case 8: $accepted = "<span class='text-center  text-success'>Memory limit exceeded [ $case ] </span>";
            break;
        default: $accepted = "<span class='text-center text-success h5'>Accepted</span>";
            break;
    }
    return $accepted;
}