                    ...
                    <tr>
                       <td colspan="6">
                           ...
                           <nav>
                               <ul class="pagination">
                                   <li>
                                       <a href="<?php print URL."status/page/$Previous"; ?>" aria-label="Previous">
                                   ...
                                   for($i = $next; $i <= $last; $i++){
                                       if($this->result == $i){
                                           print "<li class=\"active\"><a href=".URL."status/page/".$i.">$i</a></li>";
                                       }else{
                                           print "<li><a href=".URL."status/page/".$i.">$i</a></li>";
                                       }
                                   }
                                   ?>
                                   <li>
                                       <a href="<?php print URL."status/page/".($this->result+1) ?>" aria-label="Next">
